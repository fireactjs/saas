...
import { CreateSubscription, ListSubscriptions, pathnames as subPathnames, PermissionRouter, Settings, SubscriptionMenu, SubscriptionProvider, UserList } from './lib/components';
							...
							<Route path={pathnames.Subscription} element={<SubscriptionProvider loader={<Loader size="large" />} />} >
								<Route element={<AppTemplate logo={<Logo size="large" />} toolBarMenu={<UserMenu />} drawerMenu={<SubscriptionMenu />} />}>
									...
									<Route element={<PermissionRouter permissions={["admin"]} />} >
										...
										<Route exact path={pathnames.UserList} element={<UserList loader={<Loader size="large" />} />} />
									</Route>
								</Route>
							</Route>
						</Route>
